function [x10,x20] = chaotic_system_sensitivity_gamma2(k,M,N)
...
gamma20 = xi4 + bitxor(bitxor(bitxor(k(17),k(19)),k(21)),k(23))/256 + 10^(-14); % 略微改变控制参数gamma20
eta20 = xi5 + bitxor(bitxor(bitxor(k(18),k(20)),k(22)),k(24))/256;
x20(1)  = xi6 + bitxor((k(25)+k(27)+k(29)+k(31)),(k(26)+k(28)+k(30)+k(32)))/1024/10;
